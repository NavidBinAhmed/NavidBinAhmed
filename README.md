...
👋 **Passionate Data Scientist** from Bangladesh specializing in Python and JavaScript - **Python for AI use cases and Django-based web development** and **JavaScript for full-stack development** to add substantial business values that solve particular problems as complete product
...
- **Future ideas:**
    - Expanding as full-stack websites integrating advanced user interfaces by using ParticleJS, VanilaJS and Database [pranay](https://github.com/bomma-Pranay/)
